...
class ServiceManager:
    ...
    def _load_config(self) -> Dict:
        ...
        return {
            ...
            "backend": {
                ...
                "command": [sys.executable, "-m", "uvicorn", "app.main:app", "--host", "127.0.0.1", "--port", os.environ.get("BACKEND_PORT", "9002"), "--log-level", "info"],
                "cwd": "backend",
                "port": int(os.environ.get("BACKEND_PORT", "9002")),
                "env_vars": {
                    "SECRET_KEY": "testsecret123",
                    "ACCESS_TOKEN_EXPIRE_MINUTES": "60",
                    "SUPERUSER_EMAIL": "medico@pechychon.com",
                    ...
                    "BACKEND_PORT": os.environ.get("BACKEND_PORT", "9002")
                },
                "enabled": True,
                "wait_time": 3
            },
    ...
    def _print_status(self):
        ...
        endpoints = {
            ...
            "Backend API": f"http://127.0.0.1:{self.services_config['backend']['port']}",
            "Backend Docs": f"http://127.0.0.1:{self.services_config['backend']['port']}/docs",
            "Health Check": f"http://127.0.0.1:{self.services_config['backend']['port']}/healthz"
        }
